...
export default function Productlarge() {
  ...
  const phoneNumber = '91+8082660515'; // Replace with actual phone number
  const message = `Hi, I'm interested in ${state.title} priced at ${state.price}. Here is the link: ${state.image}`;
        ...
        <div className="col-md-6">
          <div className="product-details">
            ...
            <div className="action-buttons mt-4">
              ...
              <button className="btn btn-primary btn-lg"  style={{display: "none"}} onClick={handlebuynow}>
                Buy Now
              </button>
